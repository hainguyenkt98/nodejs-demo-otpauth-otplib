...
const postEnable2FA = async (req, res) => {
  try {
    ...
    // otpauth://totp/flodev.net:hainv?secret=GYCCWGRLDY3RAFBU&period=30&digits=6&algorithm=SHA1&issuer=flodev.net
